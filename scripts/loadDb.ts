...
const ASTRA_DB_API_ENDPOINT = requireEnvVar('ASTRA_DB_API_ENDPOINT')
const ASTRA_DB_COLLECTION = requireEnvVar('ASTRA_DB_COLLECTION')
...
const createCollection = async (similarityMetric: SimilarityMetric = "dot_product") => {
    const res = await db.createCollection(ASTRA_DB_COLLECTION, {
        vector: {
            // dimensions must be same as embeddings model you're using
            dimension: 1536,
